    ...
    evaluationTitles: [
      {
        ...
        evaluationInfos: [
          ...
          "色彩协调，对比度适宜（每张PPT一般不超过4种颜 色)(color)",
    ...
    evaluationTypes: [
      {
        ...
        evaluationTitles: [
          {
            evaluationTitle: "演讲表现能力(Speech Performance)",
            evaluationInfos: [
              "演讲自信程度(Self-confidence_in_Public_Speaking)",
              "演讲展现能力(Delivery)",
              "总体印象(speaker_credibility)"
            ]
          }
        ]
      },
      ...
      },
      {
        ...
        evaluationTitles: [
          {
            evaluationTitle: "PPT写作质量(Competence in Drafting a PPT)",
            evaluationInfos: [
              "结构清晰度(clear_structure)",
              "章节划分合理性(section_division)",
              "布局合理度(clear_layout)",
              "关键点突出性(highlighting_key_points)"
            ]
          }
        ]
      },
